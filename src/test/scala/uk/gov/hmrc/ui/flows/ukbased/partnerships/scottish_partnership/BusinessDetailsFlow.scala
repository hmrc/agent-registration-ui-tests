...
package uk.gov.hmrc.ui.flows.ukbased.partnerships.scottish_partnership
...
object BusinessDetailsFlow:
  ...
  def selectScottishPartnership(): Unit =
    WhatTypeOfPartnershipPage.assertPageIsDisplayed()
    WhatTypeOfPartnershipPage.selectScottishPartnership()
