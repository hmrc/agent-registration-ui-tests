...
extends BasePage:
  ...
  private val vatMissingReturns = By.id("entityFailures-2-status")
  ...
  def assertVatMissingReturns(expectedStatus: String): Unit = getText(vatMissingReturns) shouldBe expectedStatus
