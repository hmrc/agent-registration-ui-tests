...
object SoleTraderFailureDetailsIndividualFix_8_7Page
extends BasePage:

  override val path: String = "/agent-registration/conditions-not-yet-met/sole-trader-failure-details/IndividualFix.8.7"
