...
object SoleTraderFailureDetailsEntityFix_4_1Page
extends BasePage:

  override val path: String = "/agent-registration/conditions-not-yet-met/sole-trader-failure-details/EntityFix.4.1"
