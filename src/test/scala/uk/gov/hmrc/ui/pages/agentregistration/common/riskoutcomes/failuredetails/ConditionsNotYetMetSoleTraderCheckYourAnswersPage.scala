...
object ConditionsNotYetMetSoleTraderCheckYourAnswersPage
extends BaseCheckYourAnswersPage:

  override val path: String = "/agent-registration/conditions-not-yet-met/sole-trader/check-your-answers"
