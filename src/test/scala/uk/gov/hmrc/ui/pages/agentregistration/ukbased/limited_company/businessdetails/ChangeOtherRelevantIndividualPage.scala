...
extends BasePage:
  ...
  private val relevantIndividualFullNameField = By.id("otherRelevantIndividualName")

  def enterRelevantIndividualFullName(name: String): Unit = sendKeys(relevantIndividualFullNameField, name)
