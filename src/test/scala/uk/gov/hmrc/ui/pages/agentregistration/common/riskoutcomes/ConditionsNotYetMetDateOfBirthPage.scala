...
object ConditionsNotYetMetDateOfBirthPage
extends BasePage:

  override val path: String = "/agent-registration/provide-details/conditions-not-yet-met/date-of-birth"
  override val baseUrl: String = AppConfig.baseUrlAgentRegistrationFrontend

  inline def assertPageIsDisplayed(): Unit = eventually:
    getCurrentUrl should include(url)

  private val dayField = By.id("dateOfBirth.day")
  private val monthField = By.id("dateOfBirth.month")
