...
extends BasePage:
  ...
  def assertAskPartnersAndTaxAdvisorsToSignInStatus(expectedStatus: String): Unit = getText(askPartnersAndTaxAdvisorsToSignInStatus) shouldBe expectedStatus
  ...
  private val askPartnersAndTaxAdvisorsToSignInStatus = By.id("lists-2-status")
