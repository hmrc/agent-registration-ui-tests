...
package uk.gov.hmrc.ui.specs.ukbased.partnerships.scottish_limited_partnership.application.viewapplication
...
extends BaseSpec:
  ...
  Feature("View application after first stage"):
    Scenario(
      ...
      ViewApplicationPage.assertSummaryRow("Business type", "Scottish limited partnership")
