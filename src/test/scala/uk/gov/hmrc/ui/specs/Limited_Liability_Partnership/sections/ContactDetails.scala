...
object ContactDetails {
  ...
  def addContactDetails(stubData: StubbedSignInData, multiNameMatch: Boolean = false): Unit = {
    ...
    val passcode =
      PasscodeHelper.getPasscode(stubData.bearerToken, stubData.sessionId)
  ...
  def assertContactDetailsStatus(expectedStatus: String = "Completed"): Unit = {
    val actualStatus = TaskListPage.getContactDetailsStatus
