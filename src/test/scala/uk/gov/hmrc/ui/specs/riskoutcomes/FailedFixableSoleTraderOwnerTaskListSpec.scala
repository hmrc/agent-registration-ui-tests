...
import uk.gov.hmrc.ui.pages.agentregistration.common.application.fastforwardlinks.{SelectEntityFailurePage, SelectIndividualFailurePage, ShowAgentApplicationPage}
import uk.gov.hmrc.ui.pages.agentregistration.common.riskoutcomes.*
import uk.gov.hmrc.ui.pages.agentregistration.common.riskoutcomes.failuredetails.{ConditionsNotYetMetSoleTraderCheckYourAnswersPage, IndividualFixIdentityPage, IndividualFix_4_1Page, IndividualFix_4_3Page, IndividualFix_8_7Page, SoleTraderFailureDetailsEntityFix_4_1Page, SoleTraderFailureDetailsEntityFix_4_3Page, SoleTraderFailureDetailsIndividualFix_8_7Page, SoleTraderIdentityPage}
...
extends BaseSpec:
  ...
  Feature("Sole Trader Owner FailedFixable Tasklist"):
    Scenario(
      "Complete FailedFixable actions and resubmit without individual link sign in",TagFixableFailures,
      TagFixableFailures
    ):
