...
package uk.gov.hmrc.ui.specs.ukbased.partnerships.scottish_limited_partnership.application.businessdetails
...
extends BaseSpec:
  ...
  Feature("Complete BusinessDetails"):
    ...
    Scenario(
      ...
      FastForwardLinks
        .FastForward
        .runFlow(BusinessDetails, ScottishLimitedPartnership)
      ...
      CheckYourAnswersPage.assertSummaryRow("Business type", "Scottish limited partnership")
