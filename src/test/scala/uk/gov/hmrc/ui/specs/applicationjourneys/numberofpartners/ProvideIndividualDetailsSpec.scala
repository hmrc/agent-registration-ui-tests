...
package uk.gov.hmrc.ui.specs.applicationjourneys.numberofpartners
...
import uk.gov.hmrc.ui.flows.common.application.providedetails.ProvideIndividualDetailsFlow.listProgress.partial
