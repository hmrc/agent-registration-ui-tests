...
package uk.gov.hmrc.ui.specs.ukbased.partnerships.general_partnership.application.agentdetails
...
extends BaseSpec:
  ...
  Feature("Complete Business details section"):
    Scenario(
      ...
      FastForwardLinks
        .FastForward
        .runFlow(ContactDetails, GeneralPartnership)
    ...
    Scenario(
      ...
      val stubbedSignInData = FastForwardLinks
        .FastForward
        .runFlowWithStubData(AgentDetails, GeneralPartnership)
