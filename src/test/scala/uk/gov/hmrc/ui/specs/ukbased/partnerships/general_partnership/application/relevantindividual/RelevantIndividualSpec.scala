...
package uk.gov.hmrc.ui.specs.ukbased.partnerships.general_partnership.application.relevantindividual
...
extends BaseSpec:
  ...
  Feature("Applicant initiates Relevant Individual details journey"):
    Scenario(
      ...
      RelevantIndividualFlow
        .WithPartnersAndAdvisors
        .runFlow("Bobby Boucher", "bobby.boucher@example.com")
