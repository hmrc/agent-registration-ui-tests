...
package uk.gov.hmrc.ui.specs.ukbased.partnerships.scottish_partnership.application.businessdetails
...
extends BaseSpec:
  ...
  Feature("Complete BusinessDetails"):
    ...
    Scenario(
      ...
      CheckYourAnswersPage.assertSummaryRow("Business type", "Scottish partnership")
      ...
      CheckYourAnswersPage.assertSummaryRow("Partnership name", "Electronicsson Group")
