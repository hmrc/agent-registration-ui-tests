...
import uk.gov.hmrc.ui.pages.agentregistration.common.riskoutcomes.{ApplicationStatusPage, ConditionsNotYetMetApplicantTaskListPage, ConditionsNotYetMetEntityFailureDetailsV41Page, SaveAndComeBackLater}
...
extends BaseSpec:
  ...
  Feature("Applicant Failure Details Page"):
    Scenario(
      ...
      // Assert that the status of the tasks is "Incomplete"
      ConditionsNotYetMetApplicantTaskListPage.assertAmlsDetailsStatus("Incomplete")
      ConditionsNotYetMetApplicantTaskListPage.assertSelfAssessmentMissingReturns("Incomplete")
      ConditionsNotYetMetApplicantTaskListPage.assertVatMissingReturns("Incomplete")
      ...
      SaveAndComeBackLater.assertPageIsDisplayed()
